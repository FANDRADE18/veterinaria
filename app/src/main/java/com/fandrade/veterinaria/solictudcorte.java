...
public class solictudcorte extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_solictudcorte);
    ...
    private void leercredenciales() {
        ...
        solicitud.setText("Estimado "+preferences.getString("user","")
                ...
                +" y de edad "+preferences.getString("edadmascota","")+" años a la cual le realizaremos un corte ");
    }
    }
